        ...
        <div class="vcard-one main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcardProducts->count())
                    <div class="vcard-one__product mt-0">
                ...
                <div class="mt-3">
                    ...
                    <nav>
                        ...
                        <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                            <button class="active postbtn instagram-btn fs-2 text-dark py-2"
                            ...
                            <button class="instagram-btn reelsbtn fs-2 text-dark py-2"
            ...
            @if (checkFeature('iframes') && $vcard->iframes->count())
                <div class="vcard-one_iframe my-4 py-5">
                    <h4 class="vcard-one-heading text-center">{{ __('messages.vcard.iframe') }}</h4>
                    <div class="container">
                        <div class="justify-content-center overflow-hidden">
            ...
            @if (!empty($userSetting['enable_affiliation']))
                <div class="container mb-10 mt-5">
                    ...
                    <div class="bg-body p-4 border border-primary text-center rounded mb-5">
                            ...
                            <div class="modal-content animate-bottom" id="newsLatter-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3 mt-5">
                                        <input type="email" class="form-control bg-dark border-dark text-light" placeholder="{{ __('messages.form.enter_your_email') }}" name="email" id="emailSubscription"
