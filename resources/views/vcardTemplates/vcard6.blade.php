        ...
        <div class="row d-flex justify-content-center content-blur">
                ...
                @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                    @if (checkFeature('gallery') && $vcard->gallery->count())
                        <div class="main-gallery position-relative ">
                            ...
                            <div class="container mt-3 mb-5 mt-0">
                                <h3 class="text-center mb-4 text-light gallery-title">{{ __('messages.plan.gallery') }}</h3>
                                                    ...
                                                    <div class="gallery-profile">
                                                        ...
                                                        @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                                                            <a id="file_url" href="{{ $file->gallery_image }}"
                                                                class="gallery-link gallery-file-link"
                                                                target="_blank">
                    ...
                    @if (checkFeature('products') && $vcard->products->count())
                        <div class="main-product position-relative ">
                            ...
                            <div class="container mt-3 mb-5 mb-10 mt-0">
                                ...
                                <div class="text-center me-5  ms-5">
                                    <a class="fs-4  text-light p-5 mt-5"
            ...
            <nav>
                ...
                <div class="nav nav-tabs px-2" id="nav-tab" role="tablist">
                    ...
                    <button class="py-2 instagram-btn reelsbtn fs-2" id="nav-profile-tab" data-bs-toggle="tab"
