        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="vcard-thirteen__gallery gallery-section mt-2 px-sm-0">
                                ...
                                <div class="">
                                    <div class="blog-card mb-sm-0 mb-5 d-flex flex-sm-row-reverse flex-column-reverse">
                                        ...
                                        <div class="card-body text-sm-start text-center p-0 pe-sm-4">
                                            <h2 class="fs-20 text-primary bloh-head"> {{ $blog->title }}</h2>
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="contact-us-section pt-30 pb-30 px-sm-4 px-3 mt-5 bg-primary-light">
