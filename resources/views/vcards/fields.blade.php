...
@if ($partName == 'manage-section')
    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <input id="contactListCheckbox" class="form-check-input" type="checkbox" value="1" name="contact_list" {{ (isset($managesection) && ($managesection['contact_list'])) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="servicesCheckbox" class="form-check-input" type="checkbox" value="1" name="services" {{ (isset($managesection) && ($managesection['services'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="servicesCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.vcard.services') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="galleriesCheckbox" class="form-check-input" type="checkbox" value="1" name="galleries" {{ (isset($managesection) && ($managesection['galleries'])) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="productsCheckbox" class="form-check-input" type="checkbox" value="1" name="products" {{ (isset($managesection) && ($managesection['products'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="productsCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.vcard.products') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="testimonialsCheckbox" class="form-check-input" type="checkbox" value="1" name="testimonials" {{ (isset($managesection) && ($managesection['testimonials'])) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="blogsCheckbox" class="form-check-input" type="checkbox" value="1" name="blogs" {{ (isset($managesection) && ($managesection['blogs'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="blogsCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.vcard.blogs') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="businessHoursCheckbox" class="form-check-input" type="checkbox" value="1" name="business_hours" {{ (isset($managesection) && ($managesection['business_hours'])) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="appointmentsCheckbox" class="form-check-input" type="checkbox" value="1" name="appointments" {{ (isset($managesection) && ($managesection['appointments'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="appointmentsCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.vcard.appointments') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="mapCheckbox" class="form-check-input" type="checkbox" value="1" name="map" {{ (isset($managesection) && ($managesection['map'])) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="bannerCheckbox" class="form-check-input" type="checkbox" value="1" name="banner" {{ (isset($managesection) && ($managesection['banner'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="bannerCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.front_cms.banner_title') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="instaembedCheckbox" class="form-check-input" type="checkbox" value="1" name="insta_embed" {{ (isset($managesection) && $managesection['insta_embed']) || empty($managesection) ? 'checked' : '' }}>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <input id="iframeCheckbox" class="form-check-input" type="checkbox" value="1" name="iframe" {{ (isset($managesection) && ($managesection['iframe'])) || empty($managesection) ? 'checked' : '' }}>
                <label class="form-label mb-0 me-2" for="iframeCheckbox">
                    <span class="ms-4 d-md-block">{!! __('messages.vcard.iframe') !!}</span>
                </label>
            </div>
            <div class="col-6">
                <input id="newsLatterPopupCheckbox" class="form-check-input" type="checkbox" value="1" name="news_latter_popup" {{ (isset($managesection) && ($managesection['news_latter_popup'])) || empty($managesection) ? 'checked' : '' }}>
