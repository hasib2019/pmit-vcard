...
<footer class="pt-4 pb-4 bg-light">
    <div class="container text-center">
        <div class="row text-center mb-sm-auto mb-0 text-gray-300 fw-5 overflow-hidden">
            <div class="col-6"> ©Copyright {{ \Carbon\Carbon::now()->year }} Jahangirnagar University, Development By
                <a href="https://creativeitbari.com"> Creativeitbari </a> & Design By
                <a href="https://hasibuzzaman.com"> Md Hasibuzzaman </a> PMTI-Batch-26<span
                    class="text-blue">{{ $setting['app_name'] }}</span>
            </div>
